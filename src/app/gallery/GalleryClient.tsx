...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Page Heading */}
      <section className="pt-32 pb-4 bg-sand-50">
        <div className="container-ikos text-center">
          ...
          <p className="text-lg text-charcoal-100 max-w-3xl mx-auto">
            Impressions of Coconut Beach — our rooms, pool, gardens and the shores of Lake Victoria
          </p>
        </div>
      </section>
